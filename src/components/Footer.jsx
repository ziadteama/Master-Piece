...
import logo from "../assets/images/logo.svg"; // Should be a white/inverted SVG
...
const Footer = () => {
  return (
    <footer className="bg-[#061820] text-[#d0d7da] font-poppins text-sm">
        ...
        <div className="flex items-start gap-12 flex-wrap md:flex-nowrap flex-grow">
          ...
          <div className="opacity-60">
            <img
              ...
              className="h-10 object-contain invert filter "
            />
          </div>
          ...
          <div className="space-y-2 uppercase font-semibold text-white tracking-wide">
            ...
            <a href="/projects" className="block hover:opacity-80">
              Projects
            </a>
          ...
          {/* Group 2 */}
          <div className="space-y-2 uppercase font-semibold text-white tracking-wide">
            <a href="/about" className="block hover:opacity-80">
              About
            </a>
            <a href="/contact" className="block hover:opacity-80">
              Contact
            </a>
          </div>
          ...
          {/* Group 3 */}
          <div className="space-y-2 uppercase font-semibold text-white tracking-wide">
            <a href="/terms" className="block hover:opacity-80">
              Terms
            </a>
            <a href="/privacy" className="block hover:opacity-80">
              Privacy
            </a>
          </div>
        </div>
      ...
      {/* Bottom Bar — shared across all sizes */}

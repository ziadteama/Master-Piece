...
import LogoSVG from "./LogoSVG"; // use the correct path
    ...
    <header className="fixed w-full z-50 transition-all duration-500">
      ...
      >
        ...
        <div className="w-[60px] sm:w-[72px] md:w-[84px] pt-1.5 pb-1.5 sm:pt-3 sm:pb-3 lg:pt-1 lg:pb-1 transition-all duration-300">
          <LogoSVG color={scrolled ? "#16758a" : "#ffffff"} />
        </div>
        ...
        <div className="flex flex-col justify-between h-full relative">
          ...
          <div className="border-t px-6 py-4 space-y-3 bg-white">
            <div className="flex justify-between items-center">
              <a href="tel:+20222661712" className="text-xl">📞</a>
              <a href="mailto:info@masterpiece-eg.com" className="text-xl">✉️</a>
            </div>
            <Link
              to="/contact"
              onClick={() => setMobileOpen(false)}

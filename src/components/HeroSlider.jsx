        ...
        <div className="max-w-[1320px] mx-auto px-4">
          <div className="max-w-[780px]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[12px] md:text-[15px] font-poppins uppercase tracking-[0.03em] font-bold text-white/90">
                Masterpiece Contractors
              </span>
            </div>

            <h1
              className="text-5xl md:text-6xl font-semibold font-chillax uppercase tracking-tight leading-[1.4]"
              style={{ maxWidth: "55vw" }}
            >
              Building With Precision and Integrity & Timber Systems Specialists
            </h1>
          </div>
        </div>
      </div>
